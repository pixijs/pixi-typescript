namespace glCore {
    ...
    export class GLTexture {
         ...
         */
        upload(source: HTMLImageElement|ImageData|HTMLVideoElement) {
            this.bind();
            ...
            var newWidth = (source as HTMLVideoElement).videoWidth || source.width;
            var newHeight = (source as HTMLVideoElement).videoHeight || source.height;
