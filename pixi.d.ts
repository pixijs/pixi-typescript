...
declare module PIXI
{
	...
	export class Container extends DisplayObject
	{
		...
		click(fn:(event:interaction.InteractionEvent) => void, context?:any);

		rightclick(fn:(event:interaction.InteractionEvent) => void, context?:any);

		tap(fn:(event:interaction.InteractionEvent) => void, context?:any);

		touchstart(fn:(event:interaction.InteractionEvent) => void, context?:any);

		touchend(fn:(event:interaction.InteractionEvent) => void, context?:any);

		touchendoutside(fn:(event:interaction.InteractionEvent) => void, context?:any);

		touchmove(fn:(event:interaction.InteractionEvent) => void, context?:any);

		mouseover(fn:(event:interaction.InteractionEvent) => void, context?:any);

		mousemove(fn:(event:interaction.InteractionEvent) => void, context?:any);

		mouseout(fn:(event:interaction.InteractionEvent) => void, context?:any);

		mousedown(fn:(event:interaction.InteractionEvent) => void, context?:any);

		rightedown(fn:(event:interaction.InteractionEvent) => void, context?:any);

		mouseup(fn:(event:interaction.InteractionEvent) => void, context?:any);

		mouseupoutside(fn:(event:interaction.InteractionEvent) => void, context?:any);

		rightupoutside(fn:(event:interaction.InteractionEvent) => void, context?:any);

		rightup(fn:(event:interaction.InteractionEvent) => void, context?:any);
	...
	export class GraphicsData
	{
		...
		ructor(lineWidth:number, lineColor:number, lineAlpha:number, fillColor:number, fillAlpha:number, fill:boolean, shape:Circle | Rectangle | Ellipse | Polygon);
