...
namespace core.renderers {
    ...
    import RENDERER_TYPE = core.RENDERER_TYPE;
    import settings = core.settings;
    const tempMatrix = new core.math.Matrix();
    ...
    //     _backgroundColorRgba: Float32Array;
    ...
    //         // prepare options
    //         if (options) {
    //             for (const i: any in (settings.RENDER_OPTIONS as any)) {
    ...
    //          * @private
    //          */
    //         this._backgroundColorRgba = new Float32Array(4);
    //
    //         /**
